...
namespace SIM.Sitecore9Installer.Tests.Validation.Validators
{
  public class CertificateValidatorTests
  {
    ...
    public void CertificateDoesNotExist(IEnumerable<Task> tasks)
    {
      ...
      val.WhenForAnyArgs(a=>a.FindCertificates(null, null)).DoNotCallBase();
      val.FindCertificates(null,null).ReturnsForAnyArgs(new X509Certificate2Collection());
      val.Data["StoreName"] = "Root";
      val.Data["ParamNames"] = p.Name;
      
      Assert.False(val.Evaluate(tasks).Any(r => r.State == Sitecore9Installer.Validation.ValidatorState.Error));
    ...
    public void CertificateIsValid(IEnumerable<Task> tasks)
    {
      ...
      val.FindCertificates(null, null).ReturnsForAnyArgs(collection);
      val.Data["StoreName"] = "Root";
      val.Data["ParamNames"] = p.Name;
