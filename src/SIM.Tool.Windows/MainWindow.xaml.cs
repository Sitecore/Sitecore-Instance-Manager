  ...
  public partial class MainWindow
  {
    ...
    public MainWindow()
    {
      ...
      using (new ProfileSection("Main window ctor"))
      {
        ...
        Title = string.Format(Title, ApplicationManager.IsQa ? "QA" : (ApplicationManager.IsDev ? "DEV" : ""), ApplicationManager.AppShortVersion, ApplicationManager.AppThreePartVersion, ApplicationManager.AppLabel);
