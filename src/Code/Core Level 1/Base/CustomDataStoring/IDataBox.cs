...
namespace SIM.Base.CustomDataStoring
{
  public interface IDataBox
  {
    ...
    /// <summary>
    /// Get SubBox with specified name and save strategy. SPecified strategy will be used to handle box and SubBox changes (if SubBox doesn't have its own strategy).
    /// </summary>
