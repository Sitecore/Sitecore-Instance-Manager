...
namespace SIM.Tool.Base.Runtime
{
  public static class LifeManager
  {
    ...
    {
      add { SingleInstanceLock.AttemptFromAnotherProcess += value; }
      remove { SingleInstanceLock.AttemptFromAnotherProcess -= value; }
    }
    ...
    /// <summary>
    /// This flag indicating that instance is restarting.
    /// </summary>
