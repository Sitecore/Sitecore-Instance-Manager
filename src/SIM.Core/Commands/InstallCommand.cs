namespace SIM.Commands.Commands
{
  ...
  public class InstallCommand : AbstractCommand
  {
    ...
    protected override void DoExecute(CommandResultBase result)
    {
      ...
      var installArgs = new InstallArgs(name, name, distributive, rootPath, builder, sqlServerAccountName, webServerIdentity, new FileInfo(license), true, false, false, false, false, new Product[0]);
