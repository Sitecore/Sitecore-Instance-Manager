...
Finish|Done.|True";
    ...
    #region Nested type: TestArgs

    private class TestArgs : ProcessorArgs
    {
    ...
    private class TestController : IPipelineController
    {
      ...
      double IPipelineController.Maximum { get; set; }

      Pipeline IPipelineController.Pipeline { get; set; }
    ...
    #region Nested type: TestProcessor
